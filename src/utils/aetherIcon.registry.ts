...
const APP_ICONFONT_CLASS_MAP: Record<AetherIconName, string> = {
  ...
  'arrow-right': 'aether-icon-chevron-right',
  ...
  'check-circle-2': 'aether-icon-shield-check',
  'chevron-right': 'aether-icon-chevron-right',
  'circle-x': 'aether-icon-x',
  clock: 'aether-icon-history',
  ...
  // APP iconfont 暂无 receipt glyph，先回退到 history 近似订单流水形态
  receipt: 'aether-icon-history',
