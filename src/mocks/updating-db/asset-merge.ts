...
const cloneYieldAssets = (assets: AssetMergeYieldAssetDto[]): AssetMergeYieldAssetDto[] =>
        ...
        materials: [
          {
            ...
            owned: 2,
            required: 2,
            coverImageUrl: '/static/home/market/c02-market.jpg',
          },
          {
            id: 'mat-099-pulse',
            name: '脉冲核心',
        ...
        materials: [
          {
            ...
            owned: 3,
            required: 5,
            coverImageUrl: '/static/home/market/c11-market.png',
          },
          {
            id: 'mat-099-canvas',
            name: '基础画布',
            owned: 1,
            required: 1,
            coverImageUrl: '/static/home/market/c12-market.png',
          },
        ],
      },
    ],
    ...
    recipes: [
      {
        ...
        materials: [
          ...
          },
          {
            ...
            owned: 0,
            required: 1,
            coverImageUrl: '/static/home/market/c15-market.png',
          },
        ],
      },
    ],
        ...
        materials: [
          {
            ...
            owned: 0,
            required: 1,
            coverImageUrl: '/static/home/market/c16-market.png',
          },
          {
            id: 'mat-097-canvas',
            name: '基础画布',
...
export const cloneAssetMergeEventDb = (): AssetMergeEventDto[] =>
  assetMergeEventDb.map((event) => ({
    ...
    yieldAssets: cloneYieldAssets(event.yieldAssets),
