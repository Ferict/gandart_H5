...
export const HOME_TRACK_HOME_TOPBAR_HEIGHT_PX = 64
export const HOME_TRACK_REFRESH_CLEARANCE_BELOW_TOPBAR_PX = 16
export const HOME_TRACK_REFRESH_TOP_OFFSET_PX =
  HOME_TRACK_HOME_TOPBAR_HEIGHT_PX + HOME_TRACK_REFRESH_CLEARANCE_BELOW_TOPBAR_PX
export const HOME_TRACK_REFRESH_SLOT_MAX_HEIGHT_PX = 80
