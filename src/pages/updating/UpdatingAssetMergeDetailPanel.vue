  ...
  <view class="asset-merge-detail">
    ...
    <view class="asset-merge-detail-block">
      <view class="asset-merge-detail-section-head">
        ...
        <text class="asset-merge-detail-section-meta">目标藏品</text>
      </view>

      <view v-if="primaryYieldAsset" class="asset-merge-yield-grid is-single">
        <view :key="primaryYieldAsset.id" class="asset-merge-yield-card">
          <image
            class="asset-merge-yield-image"
            :src="primaryYieldAsset.coverImageUrl"
            mode="aspectFill"
          />
          <view class="asset-merge-yield-shade" />
          <view class="asset-merge-yield-copy">
            <text class="asset-merge-yield-level">{{ primaryYieldAsset.level }}</text>
            <text class="asset-merge-yield-title">{{ primaryYieldAsset.title }}</text>
          </view>
        </view>
      </view>
    </view>
    ...
    <view class="asset-merge-stat-card">
      <view class="asset-merge-stat">
        <view class="asset-merge-stat-label-row">
          <AetherIcon name="clock" :size="13" :stroke-width="2" tone="danger" />
...
const primaryYieldAsset = computed(() => props.event.yieldAsset)
