      ...
      categories: [
        {
          categoryId: 'cat-001',
          categoryName: '艺术',
          marketKinds: ['collections'],
        },
        {
          categoryId: 'box-001',
          categoryName: '盲盒系列',
          marketKinds: ['blindBoxes'],
        },
      ],
      actions: [
        {
...
describe('home rail content adapters', () => {
  it('maps home scene dto blocks into the home rail model', () => {
    ...
    expect(content.market.tags).toEqual([
      { id: 'cat-001', label: '艺术', marketKinds: ['collections'] },
      { id: 'box-001', label: '盲盒系列', marketKinds: ['blindBoxes'] },
    ])
    ...
    expect('sortConfig' in content.market).toBe(false)
  })
